...
if (isset($_POST['cambia_email'])) {
    ...
    echo "<p style='color: green;'>Email aggiornata con successo.</p>";
}
...
if (isset($_POST['cambia_password'])) {
    ...
    if ($nuova_password !== $conferma_password) {
        echo "<p style='color: red;'>Le nuove password non coincidono.</p>";
    } elseif (strlen($nuova_password) < 6) {
        echo "<p style='color: red;'>La nuova password deve contenere almeno 6 caratteri.</p>";
    } else {
        ...
        if ($result_pw && $row_pw = $result_pw->fetch_assoc()) {
            if (password_verify($vecchia_password, $row_pw['pw'])) {
                ...
                echo "<p style='color: green;'>Password aggiornata con successo.</p>";
            } else {
                echo "<p style='color: red;'>La vecchia password non è corretta.</p>";
            }
        }
    }
}
    ...
    <main class="account-main">
        <section class="account-section">
            ...
            <form method="POST">
                ...
                <input type="email" name="nuova_email" id="nuova_email">
