...
CREATE DATABASE IF NOT EXISTS `ouparfum` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `ouparfum`;

-- Dump della struttura di tabella ouparfum.categorie
...
-- Dump dei dati della tabella ouparfum.categorie: ~8 rows (circa)
DELETE FROM `categorie`;
INSERT INTO `categorie` (`id`, `aroma`, `genere`) VALUES
...
CREATE TABLE IF NOT EXISTS `utenti` (
  ...
  `stato` char(1) NOT NULL DEFAULT 'u',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `utenti` (`id`, `mail`, `pw`, `stato`) VALUES
	...
	(4, 'admin@gmail.com', '$2y$10$XJLLsBm2hf7XZcAhNHhei.EuOSPawHgLwvdldvpQ.EDjLupi.TFkC', 'a');
